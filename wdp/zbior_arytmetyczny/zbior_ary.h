...
typedef struct zbior_ary {
  unsigned wielkosc; // ile ciągów znajduje się w tym zbiorze arytmetycznym
  int *lewe; // lewe konce przedzialow
  int *prawe; // prawe konce przedzialow
  int *reszty; // reszta mod q
} zbior_ary;
